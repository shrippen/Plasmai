...
Current release artifact: **`Plasmai-1.6.0.plasmoid`**

## 2. Test the package locally

```bash
kpackagetool6 -r com.github.shrippen.plasmai -t Plasma/Applet 2>/dev/null || true
kpackagetool6 -i ./Plasmai-1.6.0.plasmoid -t Plasma/Applet
```
...
5. Upload **`Plasmai-1.6.0.plasmoid`** as the downloadable content.
...
```bash
git tag -a v1.6.0 -m "Plasmai 1.6.0"
