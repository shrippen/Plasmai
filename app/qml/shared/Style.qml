...
/**
 * Colors, fonts and shapes of the app. Every page and app/qml/shared
 ...
 *           the platform theme.
 *
 * Copy of contents/ui/Style.qml (fonts from the app's qrc).
 *
 * `kind` is bound from the `visualStyle` setting (shared.json) in main.qml.
 */
QtObject {
    id: root
    ...
    // ── Fonts ────────────────────────────────────────────────────────────
    // Bundled via the qrc from contents/fonts (SIL OFL, OFL.txt there).
    readonly property FontLoader headingFace: FontLoader { source: "qrc:/fonts/Rajdhani-700.ttf" }
    readonly property FontLoader monoFace: FontLoader { source: "qrc:/fonts/JetBrainsMono-400.ttf" }
    readonly property FontLoader monoMediumFace: FontLoader { source: "qrc:/fonts/JetBrainsMono-500.ttf" }
