...
ColumnLayout {
    ...
    KanteDialog {
        ...
        // Buttons live in contentItem rather than `footer: DialogButtonBox` —
        // that combo triggers a Qt Quick Controls Material-style implicitHeight
        // binding loop (harmless but noisy) on some Qt versions.
        contentItem: ColumnLayout {
            ...
            RowLayout {
                ...
                KanteButton {
                    ...
                    Layout.preferredHeight: TouchUi.active ? TouchUi.buttonMinHeight : implicitHeight
                    text: i18n("Cancel")
                    onClicked: overlapDialog.reject()
                }
            }
        }
